...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_cycles', type=int, default=10,
                        help='Maximum number of candidate periods to consider from FFT spectrum')
    parser.add_argument('--attn_dropout', type=float, default=0.15,
                        help='Dropout rate for attention mechanisms, prevents attention overfitting')
    parser.add_argument('--wv', type=str, default='db2',
                        help='Wavelet filter type. Supports all wavelets available in PyTorch Wavelets')
    parser.add_argument('--kernel_size', default=None,
                        help='Specify the length of randomly initialized wavelets (if not None)')
    parser.add_argument('--m', type=int, default=2, help='Number of levels for the stationary wavelet transform')


    # basic config
    parser.add_argument('--is_training', type=int, required=True, default=1, help='status')
    parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
    parser.add_argument('--model', type=str, required=True, default='AdaCycle', help='model name')
    ...
    parser.add_argument('--cycle', type=int, default=0, help='cycle length')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_pl{}_bz{}_lr{}_lj{}_al{}_dm{}_dp{}_tk{}_wv{}_m{}_df{}_itr{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
